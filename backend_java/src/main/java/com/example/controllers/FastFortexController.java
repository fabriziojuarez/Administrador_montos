...
public class FastFortexController {
    ...
    public static String getTotal(String moneda_base){
        Double total_moneda_base = 0.0;
        String sql = "SELECT SUM(monto_registro) as 'total', moneda_registro as 'moneda' FROM registros GROUP BY registros.moneda_registro";
        try(
        ...
        return "{ \"total_convertido\": " + total_moneda_base + ", \"moneda_base\": \"" + moneda_base + "\" }";
    }
}
